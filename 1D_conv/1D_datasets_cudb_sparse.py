...
from sparseconnect_filters import sparseconnect_layer, sparseconnect_CNN_layer_filter, sparseconnect_CNN_layer, sparseconnect_CNN_layer_filter_1D, sparseconnect_CNN_layer_1D
...
# x = sparseconnect_CNN_layer_filter_1D(n_connect_ch = 30, 
                              # filters = 128, 
                              # kernel_size = 3,
                              # channel_size = 64,
                              # activation='relu',
...
# x = sparseconnect_CNN_layer_filter_1D(n_connect_ch =50, 
                              # filters = 256, 
                              # kernel_size = 3,
                              # channel_size = 128,
                              # activation='relu',
...
# x = sparseconnect_CNN_layer_filter_1D(n_connect_ch =80, 
                              # filters = 512, 
                              # kernel_size = 3,
                              # channel_size = 256,
                              # activation='relu',
...
# x = sparseconnect_CNN_layer_filter_1D(n_connect_ch =120, 
                              # filters = 512, 
                              # kernel_size = 3,
                              # channel_size = 256,
                              # activation='relu',
...
# x = sparseconnect_layer(512, 100 ,activation='relu',n_epochs=100, tempIncr=5)(x)
# x = BatchNormalization()(x)
# x = relu(x)
# x = Dropout(0.4)(x)

# y = sparseconnect_layer(2, 50 ,activation='softmax',n_epochs=100, tempIncr=5)(x)
...
x = sparseconnect_layer(100, 60 ,activation='relu',n_epochs=100, tempIncr=5)(x)
x = BatchNormalization()(x)
x = relu(x)
#x = Dropout(0.4)(x)

y = sparseconnect_layer(2, 15 ,activation='softmax',n_epochs=100, tempIncr=5)(x)
#y = Dense(2, activation='softmax')(x)
...
model.fit(x=x_train_, y=y_train_, batch_size = 64, epochs =45, verbose=1)

model.evaluate(x=x_test_, y=y_test_, batch_size = 64)
