...
def preprocessing(selector):
    ...
    *******************************************************************************
    ...
    synthetic data
    """
    rep = 8 ## number of times data is generated for each label = 1
...
x = sparseconnect_layer(80, 40 ,activation='relu',n_epochs=100, tempIncr=5)(x)
x = BatchNormalization()(x)
x = relu(x)
#x = Dropout(0.4)(x)
...
model.fit(x=x_train_, y=y_train_, batch_size = 64, epochs =35, verbose=1)
