...
def preprocessing(selector):
    ...
    *******************************************************************************
    ...
    # synthetic data
    # """
    # rep = 3 ## number of times data is generated for each label = 1
...
model.fit(x=x_train_images, y=y_train_, batch_size = 64, epochs =10, verbose=1)
