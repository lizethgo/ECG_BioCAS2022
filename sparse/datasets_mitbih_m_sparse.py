...
def preprocessing(selector):
    ...
    *******************************************************************************
    ...
    synthetic data
    """
    rep = 10 ## number of times data is generated for each label = 1
...
x = sparseconnect_CNN_layer_filter(n_connect_ch = 30, 
                              filters = 128, 
...
x = sparseconnect_CNN_layer_filter(n_connect_ch =50, 
                              filters = 256, 
                              kernel_size = kernel_size,
                              channel_size = 128,
                              activation='relu',
...
x = sparseconnect_layer(2, 50 ,activation='softmax',n_epochs=10, tempIncr=5)(x)
x = BatchNormalization()(x)
...
#
model.fit(x=x_train_images, y=y_train_, batch_size = 32, epochs=35, verbose=1)
