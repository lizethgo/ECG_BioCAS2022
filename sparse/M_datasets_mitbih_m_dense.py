...
# COMMENTED BELOW IS THE FINAL MODEL REPORTED IN BIOCAS
...
# x = Conv2D(8,(2,2), activation=None , padding='same')(x)
# x = BatchNormalization()(x)
# x = relu(x)
...
# #x = MaxPooling2D((2,2))(x)
# x = Conv2D(16,(2,2), activation=None , padding='same')(x)
# x = BatchNormalization()(x)
# x = relu(x)
...
#
model.fit(x=x_train_images, y=y_train_, batch_size = 64, epochs=45, verbose=1)   ##45 for final model
