...
from sparseconnect_filters_q4 import sparseconnect_layer,  sparseconnect_CNN_layer, sparseconnect_CNN_layer_1D
...
x = sparseconnect_layer(100, 120 ,activation='relu',n_epochs=100, tempIncr=5)(x)
x = BatchNormalization()(x)
x = relu(x)
#x = Dropout(0.4)(x)

x = sparseconnect_layer(2, 50 ,activation='softmax',n_epochs=100, tempIncr=5)(x)
x = BatchNormalization()(x)
...
model.fit(x=x_train_, y=y_train_, batch_size = 64, epochs =33, verbose=1)
