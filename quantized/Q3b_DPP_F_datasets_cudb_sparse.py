...
from sparseconnect_filters_q3_u import sparseconnect_layer, sparseconnect_CNN_layer
...
#x = BatchNormalization()(x)
#x = Activation('relu')(x)
x = sparseconnect_layer(100, 130 ,activation='softmax',n_epochs=33, tempIncr=5)(x)
x = BatchNormalization()(x)
x = relu(x)
#x = Dropout(0.4)(x)

x = sparseconnect_layer(2, 60 ,activation='softmax',n_epochs=15, tempIncr=5)(x)
x = BatchNormalization()(x)
...
#
model.fit(x=x_train_images__, y=y_train__, batch_size = 64, epochs=55, verbose=1, validation_data=(x_val,y_val))
