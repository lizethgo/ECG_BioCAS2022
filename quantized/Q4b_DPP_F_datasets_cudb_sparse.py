...
#x = BatchNormalization()(x)
#x = Activation('relu')(x)
x = sparseconnect_layer(100, 80 ,activation='softmax',n_epochs=40, tempIncr=5)(x)
x = BatchNormalization()(x)
x = relu(x)
#x = Dropout(0.4)(x)

x = sparseconnect_layer(2, 10 ,activation='softmax',n_epochs=40, tempIncr=5)(x)
x = BatchNormalization()(x)
...
#
model.fit(x=x_train_images__, y=y_train__, batch_size = 64, epochs=48, verbose=1, validation_data=(x_val,y_val))
