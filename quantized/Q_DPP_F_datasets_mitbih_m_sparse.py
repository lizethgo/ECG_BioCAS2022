...
from sparseconnect_filters_q_u import sparseconnect_layer, sparseconnect_CNN_layer
...
x = Conv2D(8,(5,5), activation=None , padding='same')(x_)
...
#x = BatchNormalization()(x)
#x = Activation('relu')(x)
x = sparseconnect_layer(100, 80 ,activation='relu',n_epochs=33, tempIncr=5)(x)
x = BatchNormalization()(x)
x = relu(x)
#x = Dropout(0.4)(x)
...
#
model.fit(x=x_train_images__, y=y_train__, batch_size = 64, epochs=100, verbose=1, validation_data=(x_val,y_val))
